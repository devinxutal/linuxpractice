...
public class AdDaemon {
	...
	public AdDaemon(String name, Activity activity, View adView, Handler handler) {
		...
		}else if (this.adView instanceof net.youmi.android.AdView) {
			final net.youmi.android.AdView v = (net.youmi.android.AdView) adView;
					...
					if (adView != null) {
						if (adView instanceof com.google.ads.AdView) {
							((com.google.ads.AdView) adView).loadAd(AdUtil
									.getAdRequest());
						}if (adView instanceof net.youmi.android.AdView) {
							final net.youmi.android.AdView v = (net.youmi.android.AdView) adView;
